...
namespace em::values::functions {
  NativeFunction::NativeFunction(std::wstring identifier, ImplementationFunction implementation)
      : mIdentifier(std::move(identifier)), mImplementation(std::move(implementation)) {}
  ...
  ast::NodeVisitor::VisitorRetValue NativeFunction::execute(runtime::Interpreter& interpreter,

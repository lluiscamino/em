...
namespace em {
  void EmLang::runProgram(const std::wstring& program, const std::shared_ptr<std::ostream>& outputStream) {
    ...
    astTreeDiagramGenereator.generate(ast, std::filesystem::current_path() / "ast.dot");
